    ...
    >
      ...
      <v-card-title>
        <v-toolbar color="primary" dark>
          <v-toolbar-title>New Punt Makeup Template</v-toolbar-title>
        </v-toolbar>
      </v-card-title>
      ...
      <v-container grid-list-md class="pb-2 pt-3 px-4">
        <v-layout wrap>
          <v-flex xs12>
            <v-text-field
              v-model="localModel.templateName"
              label="Name"
              v-validate="'required'"
              data-vv-name="name"
          ...
          <v-flex xs12>
            <v-text-field
              v-model="localModel.templateDescription"
              label="Description"
              v-validate="'required'"
...
export default {
  name: 'new-punt-makeup-template-dialog',
